<?php
    ...
    class SubmitRequest extends WCTPOperation
    {
        ...
        public function xml(): SimpleXMLElement
        {
            ...
            $submitHeader = $submitRequest->addChild('wctp-SubmitHeader' );
            ...
            $originator = $submitHeader->addChild('wctp-Originator' );
            ...
            $messageControl = $submitHeader->addChild('wctp-MessageControl' );
